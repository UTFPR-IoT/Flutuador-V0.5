...
void Gravity_DO::setFullSatVoltage(float voltage) {
    //this->Do.full_sat_voltage = voltage - 1170;
    //this->Do.full_sat_voltage = voltage - 704;
    this->Do.full_sat_voltage = voltage;
}
